...
export const TASKS = [
  ...
  { id: 'B3', fasa: 1, jalur: 'B', nama: 'Auth & role (4 peran) + middleware', clear: 'Membuat sistem masuk dan aturan hak akses: kader hanya mengisi, pembina/kepala Puskesmas membaca, admin mengelola.', level: 'M', jam: 10, dep: ['B1'] },
  ...
  { id: 'C2', fasa: 1, jalur: 'C', nama: 'Halaman login', clear: 'Membuat halaman masuk yang sederhana dan mudah dipakai 4 peran pengguna.', level: 'S', jam: 5, dep: ['C1'] },
  ...
  { id: 'D2', fasa: 3, jalur: 'D', nama: 'Akun demo 4 peran + data placeholder', clear: 'Menyiapkan 4 akun contoh (kader, pembina, kepala Puskesmas, admin) dengan data pengisi agar klien langsung bisa mencoba dari HP/PC.', level: 'S', jam: 2, dep: ['D1'] },
